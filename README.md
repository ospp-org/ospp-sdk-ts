...
TypeScript SDK for the OSPP (Open Self-Service Point Protocol), pinned to spec `v0.43.0`.
...
- **120 error codes** with severity, recoverable, and HTTP status metadata
- **28 configuration keys** with type, access mode, mutability, and default values
